...
ONE_OBJECT_BACKEND_REPOSITORY ?= voiceofhu/one-object-server
ONE_OBJECT_WEB_REPOSITORY ?= voiceofhu/one-object-web
ONE_OBJECT_BACKEND_DIR ?= $(SOURCE_ROOT)/one-object/backend
ONE_OBJECT_WEB_DIR ?= $(SOURCE_ROOT)/one-object/web
