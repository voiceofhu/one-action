...
require_text "$publisher" "repository: \${{ inputs.workflow_name == 'one-user' && 'voiceofhu/one-user-backend' || inputs.workflow_name == 'one-object' && 'voiceofhu/one-object-server' || inputs.workflow_name == 'one-pay' && 'voiceofhu/one-pay-server' || inputs.workflow_name == 'one-notify' && 'voiceofhu/one-notify-server' || (inputs.workflow_name == 'one-browser-app-server' || inputs.workflow_name == 'one-browser-server') && 'voiceofhu/one-browser-server' || 'voiceofhu/one-node-server' }}"
require_text "$publisher" "repository: \${{ inputs.workflow_name == 'one-user' && 'voiceofhu/one-user-web' || inputs.workflow_name == 'one-object' && 'voiceofhu/one-object-web' || inputs.workflow_name == 'one-pay' && 'voiceofhu/one-pay-web' || inputs.workflow_name == 'one-notify' && 'voiceofhu/one-notify-web' || (inputs.workflow_name == 'one-browser-app-server' || inputs.workflow_name == 'one-browser-server') && 'voiceofhu/one-browser-web' || 'voiceofhu/one-node-web' }}"
require_text "$publisher" "org.opencontainers.image.source=https://github.com/\${{ inputs.workflow_name == 'one-user' && 'voiceofhu/one-user-backend' || inputs.workflow_name == 'one-object' && 'voiceofhu/one-object-server' || inputs.workflow_name == 'one-pay' && 'voiceofhu/one-pay-server' || inputs.workflow_name == 'one-notify' && 'voiceofhu/one-notify-server' || (inputs.workflow_name == 'one-browser-app-server' || inputs.workflow_name == 'one-browser-server') && 'voiceofhu/one-browser-server' || 'voiceofhu/one-node-server' }}"
...
require_text "$user_release" 'make --no-print-directory -C "$PROJECT_ROOT" validate-user'
...
require_text "$node_server_release" 'pnpm --dir "$ONE_NODE_WEB_DIR" install --frozen-lockfile'
require_text "$node_server_release" 'pnpm --dir "$ONE_NODE_WEB_DIR" lint'
